...
function Index(props) {
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    style: {
      ...
      padding: svgPadding ? svgPadding : !_.isEmpty(treeNodes) && "10px ".concat((svgWidth - 2 * Math.floor(treeNodes[0].x)) / 2, "px")
    }
  }, /*#__PURE__*/React.createElement("g", {
    className: "tree_node"
  }, _.map(treeNodes, function (node, index) {
    ...
    className: "tree_line"
  }, _.map(treeLinks, function (link, i) {
    var start = {
      x: link.source.x,
      y: link.source.y
    };
