...
function Index(props) {
  var _props$data = props.data,
      ...
      lineColor = _props$lineColor === void 0 ? '#EEEEEE' : _props$lineColor,
      _props$childCardWidth = props.childCardWidth,
      childCardWidth = _props$childCardWidth === void 0 ? 130 : _props$childCardWidth,
      _props$childCardHeigh = props.childCardHeight,
      childCardHeight = _props$childCardHeigh === void 0 ? 155 : _props$childCardHeigh,
      _props$cardStrokeWidt = props.cardStrokeWidth,
      cardStrokeWidth = _props$cardStrokeWidt === void 0 ? 4 : _props$cardStrokeWidt,
      _props$cardPadding = props.cardPadding,
      cardPadding = _props$cardPadding === void 0 ? 20 : _props$cardPadding,
      _props$imgWidth = props.imgWidth,
      imgWidth = _props$imgWidth === void 0 ? 50 : _props$imgWidth,
  ...
  var tree$1 = React.useRef(null);
  var treeSelect = React.useRef(null);
  ...
  var _useState5 = React.useState(1),
      ...
      transScale = _useState6[0],
      setTransScale = _useState6[1];
  /** 遍历data,如果没有imgSrc就默认 */


  var handleData = function handleData(data) {
    ___default['default'].map(data, function (d) {
      if (___default['default'].has(d, 'children')) {
        d.imgSrc = ___default['default'].isEmpty(d.imgSrc) ? userPng : d.imgSrc;
  ...
  React.useEffect(function () {
    if (!___default['default'].isEmpty(data)) {
      var dataClone = ___default['default'].cloneDeep(data);
      ...
      treeSelect.current = select('tree_svg');
      var hierarchyData = hierarchy(dataClone); // hierarchy 把处理后的数据变成层次关系，分成Node(点)和link(线)
  ...
  var decriptionText = function decriptionText(text) {
    if (!___default['default'].isEmpty(text)) {
      var arr = text.split('\n');
      return ___default['default'].map(arr, function (d, i) {
        return /*#__PURE__*/React__default['default'].createElement("tspan", {
          x: "0",
          y: 22 + i * (fontSize + 4),
          fontSize: "14",
          fill: "#888888"
  ...
  var zoomDown = function zoomDown() {
    // d3.zoom().scaleTo(treeSelect.current, transScale - 0.05);
    setTransScale(transScale - 0.05);
  };
  ...
  return /*#__PURE__*/React__default['default'].createElement("div", {
    ...
    height: svgHeight,
    style: {
      transform: "scale(".concat(transScale, ")"),
      padding: svgPadding ? svgPadding : !___default['default'].isEmpty(treeNodes) && "10px ".concat((svgWidth - 2 * Math.floor(treeNodes[0].x)) / 2, "px")
    }
  }, /*#__PURE__*/React__default['default'].createElement("g", {
    className: "tree_node"
  }, ___default['default'].map(treeNodes, function (node, index) {
    return index === 0 ? /*#__PURE__*/React__default['default'].createElement("g", {
      ...
      width: cardWidth,
      height: cardHeight,
      transform: "translate(-".concat(cardWidth / 2, ", ").concat(cardStrokeWidth, ")"),
      rx: 8,
      ry: 8
    ...
    }, node.data.name), decriptionText(node.data.description))) : /*#__PURE__*/React__default['default'].createElement("g", {
      transform: "translate(".concat(node.x, ", ").concat(node.y, ")")
    }, /*#__PURE__*/React__default['default'].createElement("defs", null, /*#__PURE__*/React__default['default'].createElement("clipPath", {
      id: "clip".concat(index)
    }, /*#__PURE__*/React__default['default'].createElement("circle", {
      ...
      transform: "translate(-".concat(childCardWidth / 2, ", 0)"),
      rx: 8,
      ry: 8
    }), /*#__PURE__*/React__default['default'].createElement("image", {
      href: node.data.imgSrc,
    ...
    className: "tree_line"
  }, ___default['default'].map(treeLinks, function (link, i) {
    var start = {
      x: link.source.x,
      y: link.source.y
    };
    ...
    return start.x === treeLinks[0].source.x && start.y === treeLinks[0].source.y ? /*#__PURE__*/React__default['default'].createElement("path", {
      key: i,
      d: "M".concat(start.x, ",").concat(start.y + cardHeight + cardStrokeWidth, " L").concat(start.x, ",").concat(start.y + cardHeight + cardStrokeWidth + 30, " L").concat(end.x, ",").concat(start.y + cardHeight + cardStrokeWidth + 30, " ").concat(end.x, ",").concat(end.y),
      fill: "none",
      stroke: lineColor,
      ...
      key: i,
      d: "M".concat(start.x, ",").concat(start.y + childCardHeight + cardStrokeWidth, " L").concat(start.x, ",").concat(start.y + childCardHeight + cardStrokeWidth + 30, " L").concat(end.x, ",").concat(start.y + childCardHeight + cardStrokeWidth + 30, " ").concat(end.x, ",").concat(end.y),
      fill: "none",
      stroke: lineColor,
      strokeWidth: "2" // markerEnd='url(#arrow)'
